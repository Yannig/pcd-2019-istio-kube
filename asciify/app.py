...
@app.route('/asciify/<path>')
def asciify_convert(path):
    image = Image.open(path)
    return f"<pre>{convert_to_ascii(image)}</pre>"


@app.route('/')
def root():
    return "<p><a href='/healthcheck'>Healthcheck</a></p>" + \
           "<p><a href='/environment'>Environment</a></p>" + \
           "<p>Test service : <a href='/asciify/grumpy.webp'>Grumpy Ascii</a></p>"
